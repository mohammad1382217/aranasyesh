...
export const postCompanyWorkwithus = (Object: CompanyWorkwithus): (() => void) => {
  ...
  const PostCompany = async () => {
    ...
    try {
      const response = await axiosInstance.post("request/company/", Object, {
  ...
  PostCompany(); // Start fetching immediately
