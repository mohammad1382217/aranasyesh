...
export const fetchZarinPal = (dispatch: Dispatch<Action>, Id: number): (() => void) => {
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await axiosInstance.get(`product/transaction/${Id}/buy/`, {
                cancelToken: cancelTokenSource.token,
            });
            const data = response.data;
            dispatch({ type: "FETCH_SUCCESS_ZARINPAL", payload: data });
        } catch (error) {
