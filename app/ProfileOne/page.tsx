                    ...
                    >
                      <div className="flex items-center gap-2 sm:gap-4">
                        ...
                        {account?.results[0]?.subscription.is_buy ? (
                          ...
                          <Link
                            to="/BuySubscription"
                            className="text-base xs:text-xs font-light text-white"
                          >
                            خرید اشتراک
                          </Link>
                        )}
                          ...
                          <div className="w-full flex xs:flex-col gap-3">
                            <div className="w-full flex flex-col gap-2">
                              <Input
                                ...
                                sizing="md"
                              />
                              {UserState.editProfile!.first_name?.length ===
                              0 ? (
                            ...
                            <div className="w-full flex flex-col gap-2">
                              <Input
                                ...
                                sizing="md"
                              />
                              {UserState.editProfile!.last_name?.length ===
                              0 ? (
                                <div className="text-red-500 text-sm">
                                  {"فیلد را وارد کنید"}
                                </div>
                            ...
                            <div className="w-full relative inline-flex flex-col gap-2">
                              <DatePicker
                                ...
                                placeholder="تاریخ تولد"
                              />
                              {UserState.editProfile!.birth_date?.length ===
                              0 ? (
                                <div className="text-red-500 text-sm">
                                  {"فیلد را وارد کنید"}
                                </div>
