  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col justify-center items-center !px-3 md:!px-5 lg:!px-4">
        <h5 className="text-lg text-right px-2 w-full font-light tracking-tight text-[#303030] dark:text-white self-start">
          {text}
        </h5>
        ...
        <div className="w-full px-2 flex items-start p-0 justify-between self-start mx-auto">
          ...
          <span className=" text-sm md:text-xs font-extralight text-[#717171]">
            <span className="text-xs lg:text-sm font-extralight text-[#717171]">
              از {offer[0]}
              {"% "}
            </span>
            <span className="text-xs lg:text-sm font-extralight text-[#717171]">
