...
const Loading = () => {
  return (
    <div className="sweet-loading w-[100vw] h-[100vh] bg-[#F5F5F5] fixed top-0 left-0 z-50 flex flex-col justify-center items-center">
      <div className="flex flex-col gap-5 justify-center items-center xs:max-w-[300px]">
        ...
        <LazyImage src={displayloading} alt="loading" width={419} height={172} />
      </div>
    </div>
  );
};
